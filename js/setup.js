...
var fillWizards = function (wizards) {
  for (var i = 0; i < wizards.length; i++) {
    wizardFragment.appendChild(createWizards(wizards[i]));
  }
  return wizardFragment;
};
fillWizards(customizeWizards(['Иван', 'Хуан Себастьян', 'Мария', 'Кристоф', 'Виктор', 'Юлия', 'Люпита', 'Вашингтон'], ['да Марья', 'Верон', 'Мирабелла', 'Вальц', 'Онопко', 'Топольницкая', 'Нионго', 'Ирвинг'], ['rgb(101, 137, 164)', 'rgb(241, 43, 107)', 'rgb(146, 100, 161)', 'rgb(56, 159, 117)', 'rgb(215, 210, 55)', 'rgb(0, 0, 0)'], ['black', 'red', 'blue', 'yellow', 'green']));
